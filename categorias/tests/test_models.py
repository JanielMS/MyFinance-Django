...
class CategoriaModelTest(TestCase):
    def setUp(self):
        ...
        self.categoria_pai = Categoria.objects.create(nome="Transporte", tipo="D")

    def test_criar_subcategoria(self):
        """Testa se uma subcategoria pode ser criada corretamente"""
        subcategoria = Categoria.objects.create(nome="Uber", categoria_pai=self.categoria_pai, tipo="D")
    ...
    def test_nao_permitir_categoria_duplicada(self):
        ...
        with self.assertRaises(Exception):  
            Categoria.objects.create(nome="Transporte", tipo="D")  # Deve falhar
